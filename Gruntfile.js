...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    swagger_generate: {
      options: {
        baseDir: __dirname,
        swaggerOutputFile: 'doc/REST_API/swagger/group-swagger.json',
        info: {
          title: 'OpenPaaS Group Module',
          description: 'OpenPaaS Group Module API',
          version: '0.1'
        },
        host: 'localhost:8080',
        securityDefinitions: {
          auth: {
            type: 'oauth2',
            description: 'OAuth2 security scheme for the OpenPaaS Group Module API',
            flow: 'password',
